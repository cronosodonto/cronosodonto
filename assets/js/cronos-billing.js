(function(){
  ...
  function injectStyles(){
    ...
    const style=document.createElement('style');style.id='cronosBillingStyles';style.textContent=`
      ...
      html.light .billingStatus:not(.warn),body.light .billingStatus:not(.warn),:root.light .billingStatus:not(.warn){background:rgba(16,185,129,.16);color:#047857;border-color:rgba(5,150,105,.34);box-shadow:0 2px 8px rgba(5,150,105,.08)}
      .billingModalBg{position:fixed;inset:0;z-index:10050;background:rgba(2,6,23,.64);display:none;align-items:center;justify-content:center;padding:18px}.billingModalBg.show{display:flex}.billingModal{width:min(760px,96vw);max-height:90vh;overflow:auto;background:radial-gradient(900px 520px at 0% 0%,rgba(22,119,255,.24),transparent 58%),radial-gradient(760px 480px at 100% 8%,rgba(25,198,255,.18),transparent 60%),radial-gradient(820px 520px at 92% 100%,rgba(46,230,166,.16),transparent 62%),linear-gradient(135deg,#0b1220 0%,#0c1730 48%,#0b1f25 100%);border:1px solid rgba(96,165,250,.22);border-radius:22px;box-shadow:0 28px 90px rgba(0,0,0,.42);padding:18px;transition:width .18s ease}.billingModalHead{display:flex;justify-content:space-between;gap:12px;align-items:flex-start}.billingPlans{display:grid;grid-template-columns:repeat(var(--billing-plan-count,2),minmax(220px,1fr));gap:10px;margin:16px 0;overflow-x:auto;padding:2px 2px 8px;scrollbar-width:thin}.billingPlan{min-width:0;border:1px solid var(--line);border-radius:16px;padding:14px;background:rgba(255,255,255,.045);cursor:pointer;transition:transform .16s ease,border-color .16s ease,box-shadow .16s ease,background .16s ease;display:flex;flex-direction:column}.billingPlan:hover{transform:translateY(-1px);border-color:rgba(96,165,250,.42)}.billingPlan.selected{background:linear-gradient(135deg,#2563eb 0%,#0ea5e9 52%,#14b8a6 100%);border-color:rgba(255,255,255,.54);box-shadow:0 12px 28px rgba(37,99,235,.24),0 0 0 2px rgba(56,189,248,.16);color:#fff}.billingPlanTop{display:flex;align-items:center;gap:10px;margin-bottom:8px}.billingPlanIcon{width:38px;height:38px;flex:0 0 38px;border-radius:12px;display:grid;place-items:center;background:#fff;color:#2563eb;box-shadow:0 5px 16px rgba(15,23,42,.12);border:1px solid rgba(255,255,255,.9)}.billingPlanIcon svg{width:20px;height:20px;fill:none;stroke:currentColor;stroke-width:1.9;stroke-linecap:round;stroke-linejoin:round}.billingPlan strong{display:block;font-size:18px}.billingPlanPrice{font-weight:800}.billingPlanDescription{margin-top:7px;font-size:12px;line-height:1.35;min-height:32px}.billingPlanIncludes{margin-top:11px;padding-top:10px;border-top:1px solid rgba(148,163,184,.22)}.billingPlanIncludesTitle{font-size:11px;font-weight:900;text-transform:uppercase;letter-spacing:.04em;margin-bottom:7px;color:var(--muted)}.billingPlanFeatures{display:grid;gap:5px;margin:0;padding:0;list-style:none}.billingPlanFeatures li{display:flex;align-items:flex-start;gap:6px;font-size:11.5px;line-height:1.25;color:var(--text)}.billingPlanFeatures li:before{content:'✓';font-weight:1000;color:#22c55e;line-height:1.1}.billingPlan.selected strong{color:#fff!important}.billingPlan.selected .billingPlanPrice{color:#fff!important}.billingPlan.selected .muted,.billingPlan.selected .billingPlanDescription,.billingPlan.selected .billingPlanIncludesTitle,.billingPlan.selected .billingPlanFeatures li{color:rgba(255,255,255,.94)!important;opacity:1!important}.billingPlan.selected .billingPlanIncludes{border-top-color:rgba(255,255,255,.24)}.billingPlan.selected .billingPlanFeatures li:before{color:#fff}.billingPlan.selected .billingPlanIcon{background:#fff!important;color:#2563eb!important;border-color:rgba(255,255,255,.96)!important}.billingPlan.selected .billingPlanIcon svg{color:#2563eb!important;stroke:#2563eb!important}.billingFormGrid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:10px}.billingFormGrid .full{grid-column:1/-1}.billingMethods{display:flex;gap:8px;flex-wrap:wrap}.billingMethod{padding:9px 12px;border:1px solid var(--line);border-radius:12px;cursor:pointer;background:rgba(255,255,255,.025)}.billingMethod.selected{background:rgba(37,99,235,.18);border-color:#60a5fa}.billingDetails{grid-column:1/-1;margin:0;border:0;background:transparent}.billingDetails summary{list-style:none;display:inline-flex;align-items:center;gap:5px;padding:2px 0;cursor:pointer;font-size:12px;font-weight:700;color:var(--muted);transition:color .15s ease}.billingDetails summary:hover{color:var(--text)}.billingDetails summary::-webkit-details-marker{display:none}.billingDetails summary:after{content:'›';font-size:17px;line-height:1;transform:rotate(90deg);transition:transform .18s ease}.billingDetails[open] summary:after{transform:rotate(-90deg)}.billingDetailsBody{padding:10px 0 2px}.billingDetailsBody .billingFormGrid{margin-top:0}.billingPix{display:grid;justify-items:center;gap:10px;padding:14px;border:1px solid var(--line);border-radius:16px;margin-top:14px}.billingPix img{width:min(260px,80vw);background:white;padding:10px;border-radius:12px}.billingCopy{width:100%;min-height:70px}.billingGateBtn{margin-left:8px}
      html.light .billingModal,body.light .billingModal,:root.light .billingModal{background:radial-gradient(900px 520px at 0% 0%,rgba(22,119,255,.25),transparent 58%),radial-gradient(760px 480px at 100% 8%,rgba(25,198,255,.22),transparent 60%),radial-gradient(820px 520px at 92% 100%,rgba(46,230,166,.22),transparent 62%),linear-gradient(135deg,#edf6ff 0%,#eefcff 46%,#effcf6 100%);color:#0f172a;border-color:rgba(20,126,219,.20);box-shadow:0 24px 70px rgba(15,23,42,.18)}html.light .billingPlan,body.light .billingPlan,:root.light .billingPlan{background:rgba(255,255,255,.84);border-color:rgba(59,130,246,.16);box-shadow:0 6px 18px rgba(15,23,42,.035)}html.light .billingPlan.selected,body.light .billingPlan.selected,:root.light .billingPlan.selected{background:linear-gradient(135deg,#2563eb 0%,#0ea5e9 52%,#14b8a6 100%);border-color:rgba(255,255,255,.78);box-shadow:0 14px 30px rgba(37,99,235,.22),0 0 0 2px rgba(14,165,233,.13);color:#fff}.billingModal input,.billingModal select,.billingModal textarea{width:100%;box-sizing:border-box}.billingModal label{display:block;font-size:12px;font-weight:800;margin-bottom:5px;color:var(--muted)}
      @media(max-width:720px){.billingGrid,.billingFormGrid{grid-template-columns:1fr}.billingPlans{grid-template-columns:1fr;overflow-x:visible}.billingFormGrid .full{grid-column:auto}.billingModal{width:min(620px,96vw)!important}.billingPlanDescription{min-height:0}}
